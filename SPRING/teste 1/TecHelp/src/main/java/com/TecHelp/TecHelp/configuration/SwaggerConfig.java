package com.TecHelp.TecHelp.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("com.TecHelp.TecHelp.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - TecHelp").description("Projeto Integrador, Grupo - 2/Turma 27")
				.version("1.0.0").license("Apache License Version 2.0").licenseUrl("https://github.com/PietroDS1")
				.contact(contact()).build();

	}

	private static Contact contact() {
		return new Contact("PietroDev", "https://github.com/PietroDS1", "danton.pietro@gmail.com");
	}
